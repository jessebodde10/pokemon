...
export const metadata: Metadata = {
  title: 'Disclaimer',
  description:
    'Wat Valtivo AI wel en niet is: indicatieve informatie, geen taxatie-, grading- of beleggingsdienst.',
  ...
  return (
    ...
    >
      <LegalSection heading="Schattingen, geen taxaties">
        <p>
          Alle bedragen in Valtivo AI zijn schattingen met een bandbreedte. Ze
      ...
      <LegalSection heading="Geen gradingdienst">
        <p>
          Valtivo AI voert geen professionele conditiebeoordeling uit en geeft
      ...
      <LegalSection heading="Geen financieel advies">
        <p>
          Valtivo AI geeft geen koop-, verkoop- of houdadvies en doet geen
      ...
      <LegalSection heading="Merken en rechten">
        <p>
          Valtivo AI is een onafhankelijk hulpmiddel en is niet verbonden aan,
          en wordt niet gesteund door, de uitgevers of rechthebbenden van de

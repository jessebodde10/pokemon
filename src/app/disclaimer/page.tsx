...
export const metadata: Metadata = {
  title: 'Disclaimer',
  description:
    'Wat Pokora wel en niet is: indicatieve informatie, geen taxatie-, grading- of beleggingsdienst.',
  ...
  return (
    ...
    >
      <LegalSection heading="Schattingen, geen taxaties">
        <p>
          Alle bedragen in Pokora zijn schattingen met een bandbreedte. Ze zijn
          gebaseerd op de marktdata die op dat moment beschikbaar was bij de
          vermelde bron. Werkelijke verkoopprijzen hangen af van conditie,
      ...
      <LegalSection heading="Geen gradingdienst">
        <p>
          Pokora voert geen professionele conditiebeoordeling uit en geeft geen
          voorspelling van een gradingresultaat. De optionele conditie-indicatie
          is een grove inschatting en staat standaard op “onbekend” wanneer
          alleen een binderfoto beschikbaar is.
        </p>
      </LegalSection>

      <LegalSection heading="Geen financieel advies">
        <p>
          Pokora geeft geen koop-, verkoop- of houdadvies en doet geen
      ...
      <LegalSection heading="Merken en rechten">
        <p>
          Pokora is een onafhankelijk hulpmiddel en is niet verbonden aan, en

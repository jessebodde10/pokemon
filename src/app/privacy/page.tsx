...
export const metadata: Metadata = {
  title: 'Privacy',
  description:
    'Welke foto’s Pokora verwerkt, waarom, hoe lang gastanalyses bewaard blijven en hoe je je gegevens verwijdert.',
...
export default function PrivacyPage() {
  return (
    <LegalPage
      title="Privacy"
      intro="Pokora verwerkt foto’s van kaarten. Hieronder staat precies wat er gebeurt met die foto’s en met de gegevens die eruit worden afgeleid."
    ...
    >
      ...
      <LegalSection heading="Externe AI- en databronnen">
        <p>
          Afhankelijk van de configuratie kan Pokora gebruikmaken van externe
